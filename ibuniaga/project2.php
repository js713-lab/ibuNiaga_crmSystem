    ...
    <div class="content-container">
        <div class="project-header">
            <div class="project-header-bg">
                <img src="./img/project2_background.jpg" alt="Project Banner">
            </div>
        ...
        <div class="project-content">
            ...
            <div class="project-gallery">
                <div class="gallery-item">
                    <img src="./img/project2.jpg" alt="Project Image 1">
                </div>
                <div class="gallery-item">
                    <img src="./img/project2.jpg" alt="Project Image 2">
                </div>
                <div class="gallery-item">
                    <img src="./img/project2.jpg" alt="Project Image 3">
                </div>
            </div>
